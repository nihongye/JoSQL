...
/**
 * A Class for handling a gzipped file as a DataSource. <br />
 * <br />
 ...
 * </ul>
 * <h4><a name="1">Outline</a></h4> This class providers a wrapper around a file
 * such that GZIPed files will be unzipped when the {@link #getInputStream()}
 * method is called. Or that the file will be zipped with the named zip file
 * extension when the {@link #getOutputStream()} method is called. <br />
 * <br />
 * <h4><a name="2">Zip file extension</a></h4>
 * <p>
 * When used as an <b>output</b> this class expects your file to be gzipped and
 * be able to be unzipped using a GZIPInputStream. <br />
 * <br />
 * When used an an <b>input</b> we use a GZIPOutputStream to write the file in a
 * gzipped form. <br />
 * <br />
 * For the content type we only support a number of different content types and
 * this is based upon the file extension <b>without any zip file extension</b>.
 ...
 * </pre>
 * <p>
 * Will be returned and the content type would be: <b>text/plain</b>. <br />
 * <br />
 ...
 * <p>
 * The file extensions we support and their content types are listed below (in
 * other words does the file name end with the value specified):
 * </p>
 * <table border="2" cellpadding="2">
 * <tr>
 * <th>File Extension</th>
 * <th>Content Type Returned</th>
 * </tr>
 * <tr>
 ...
 * on Windows platforms <b>.doc</b> and <b>.DOC</b> are treated the same. <br />
 * <br />
 * If you know of any other content types/file extensions that <b>MUST</b> be
 * supported directly by this class then please contact
 * <b>code-monkey&#x40;gentlyweb.com</b> with details.
 * </p>
 ...
 * {@link #setFile(File)} method and potentially a different zip extension via
 * the {@link #setZipExtension(String)}. <br />
 * <br />
 * This class is NOT Thread safe and you should synchronize externally if you
 * plan to use multiple Threads with it.
 * </p>
 */
public class GZIPFileDataSource implements DataSource {
	 ...
	 * <p>
	 * We expect the file to have the file extension as given by
	 * <b>zipExtension</b>.
	 * </p>
	 * 
	 * @param f
	 *            The File.
	 * @param zipExtension
	 *            The file extension for gzipped files. Set to <code>null</code>
	 ...
	 * <b>zipExtension</b>, so if a file is called <b>myFile.txt.gz</b> and the
	 * zip extension is <b>.gz</b> then we trim off the <b>.gz</b> and then look
	 * for the "real" file extension, then determine the appropriate content
	 * type and return it. <br />
	 * <br />
	 * You should note that the file <b>DOESN'T</b> have to have the
	 * zipExtension for this method to work. <br />
	 * <br />
	 * If we don't have a specific file extension to use (see the table of <a
	 * href="#3">content type to file extension mappings</a> for full details of
	 * what this method returns.
	 * 
	 * @return The content type based upon the file extension of the file, or
	 *         <b>application/octet-stream</b> if we don't recognise the file
	 *         extension.
	 */
	...
	/**
	 * Get an appropriate InputStream for the data source. <br />
	 * <br />
	...
	/**
	 * Get an appropriate OutputStream for the data source. <br />
	 * <br />
	...
	/**
	 * Get the name of the data source. <br />
	 * <br />
