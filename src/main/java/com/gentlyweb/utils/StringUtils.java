...
public class StringUtils {
	...
	/**
	 * Given a chunk of text format it so that you return a new String with the
	 * line length equal to that passed in.
	 * 
	 * @param text
	 *            The text to format.
	 * @param lineLength
	...
	/**
	 * Indicate whether the String value has at least one character in the range
	 * specified.
	 * 
	 * @param value
	 *            The value to check.
	 ...
	 * @return Return <code>true</code> if it has at least one character in the
	...
	/**
	 * A method to chop up a String on another multi-character String and then
	 * return the results in a List. If you have a single character String then
	 * you should use java.util.StringTokenizer.
	 * 
	 * @param str
	 *            The String to chop up.
	 * @param token
	 *            The token to look for. This should be just a plain String,
	 *            this method doesn't support regular expressions.
	...
	/**
	 * Determine whether the specified string contains a value, where having a
	 * value means: <code>
	...
	/**
	 * Given a Map of String/String (or Object/Object, they will be converted to
	 * Strings before replacement) replace all instances of each one in the
	 * specified text. <br />
	 * <br />
	 * There is no guarantee about the order in which the replacements will
	 * occur, if the ordering is important then you should impose the order by
	 * using a sorted map. <br />
	 * <br />
	 * The original text will not be affected.
	 * 
	 * @param text
	 *            The text to perform the replacements on.
	 * @param map
	 *            The map of String to find in the text and replace with the
	 *            value of the map (String).
	 * @param caseSensitive
	 *            Indicate whether we should consider case when searching for
	 *            the strings.
	 * @return A new String representing the text with all the replacements
	 *         made. If any of the keys/values in the map are null then we
	 *         return "".
	 */
	...
	/**
	 * Replace all instances of the specified string in the text given. This
	 * will not recursively replace, if it finds something to replace it
	 * replaces and then goes from the place it found last.
	 * <p>
	 * It should be noted that we take copies of text and str prior to
	 ...
	 *             fault.
	 */
	public static String replaceString(String text, String str, String replace,
	        boolean caseSensitive) throws NullPointerException {
	...
	/**
	 * Indicate whether the String value has ALL of it's characters in the
	 * specified range of characters. Make sure that <b>end</b> is "greater"
	 * than <b>start</b>. If value is null return false.
	 * <p>
	 * Note: if you set <b>start</b> == <b>end</b> then you check to see if a
	 * String is made up of the same character, not useful all the time but it
	 * is sometimes.
	 * </p>
	 * 
	 * @param value
	 ...
	 * @param end
	 *            The end character of the range.
	 * @return Whether all the characters are in the range. Return
	 *         <code>true</code> if they are, <code>false</code> otherwise.
	 */
	...
	/**
	 * Given a particular String, remove any instances of the given character
	 * from it and return a new String.
	 * 
	 * @param str
	 *            The String to search for the removals.
	 * @param c
