...
public class TimeDuration {
	...
	public String format(String spec) {
		...
		if (spec.indexOf(TimeDuration.DDD) != -1) {
			...
			s = StringUtils.replaceString(s, TimeDuration.DDD,
		...
		if (spec.indexOf(TimeDuration.SSS) != -1) {
			...
			s = StringUtils.replaceString(s, TimeDuration.SSS,
		...
		if (spec.indexOf(TimeDuration.ss) != -1) {
			...
			s = StringUtils.replaceString(s, TimeDuration.ss,
		...
		if (spec.indexOf(TimeDuration.HH) != -1) {
			...
			s = StringUtils.replaceString(s, TimeDuration.HH,
		...
		if (spec.indexOf(TimeDuration.mm) != -1) {
			...
			s = StringUtils.replaceString(s, TimeDuration.mm,
