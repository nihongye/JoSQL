...
/**
 * Represents an expression that also has an alias. SELECT columns may have
 * aliases as may the functions in the "EXECUTE ON" clause.
 */
public class AliasedExpression extends Expression {
	...
	/**
	 * Return whether this expression has a fixed result. See:
	 * {@link Expression#hasFixedResult(Query)} for more details.
	 * 
	 * @param q
	 *            The Query object.
	 * @return <code>true</code> if the expression returns a fixed result,
	 ...
	 *             If an error occurs whilst trying to determine the return
	 *             type.
	 */
	...
	/**
	 * Init this expression. All that occurs here is that the aliased expression
	 * is inited via: {@link Expression#init(Query)}.
	 * 
	 * @param q
	 *            The Query object.
	 * @throws QueryParseException
	 *             If an error occurs during the initialisation of the
	 *             expression.
	 */
	 ...
	 * @throws QueryExecutionException
	 *             If something goes wrong with the execution of the expression.
	 */
	...
	/**
	 * Return a string representation of the aliased expression. Returns in the
	 * form: <b>Expression AS Alias</b>.
	 * 
	 * @return The result of calling: {@link Expression#toString()} + AS +
	 *         {@link #getAlias()}.
	 */
