...
public class BetweenExpression extends BinaryExpression {
	 ...
	 *             If the LHS, start or end cannot be inited.
	 */
	...
	public boolean isTrue(Object o, Query q) throws QueryExecutionException {
		...
		// See if the LHS is >= s.
		boolean sb = Utilities.isGTEquals(l, s);

		boolean eb = Utilities.isLTEquals(l, e);
