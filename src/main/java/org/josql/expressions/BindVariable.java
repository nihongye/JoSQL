...
/**
 * This class represents a "bind variable" used within a SQL statement. A bind
 * variable can be either:
 * <ul>
 * <li>Named - a named bind variable is prefixed with ":", the value of the
 * variable is set in the {@link Query} object via:
 * {@link Query#setVariable(String,Object)}. The parser used (javacc generated)
 * is a little picky about "reserved keywords" and as such you cannot use the
 * following as the names of bind variables: select, from, limit, execute, on,
 * all, results, where, having, order, by, group. If you <b>must</b> use one of
 * reserved names then suffix it with "$", i.e. "execute$", "limit$" and so on.</li>
 * <li>Anonymous - an anonymous bind variable is represented as "?". The value
 * of the variable is set in the {@link Query} object via:
 * {@link Query#setVariable(int,Object)}. Anonymous variables are assigned an
 * internal integer index starting at 1 and they increase by 1.</li>
 * <li>Special - there are 3 types of "special" bind variable:
 * <ul>
 * <li><b>:_currobj</b> - Indicates the current object within the execution
 * scope.</li>
 * <li><b>:_allobjs</b> - Indicates the current set of objects within the
 * execution scope.</li>
 * <li><b>:_query</b> - Indicates the Query object.</li>
 * <li><b>:_grpby</b> - Indicates the Group By object. If there are more than 1
 * group by objects then :_grpby1 ... :_grpby2 ... :_grpbyX can be used to
 * identify which group by object you mean. Remember that the group by object
 * only has meaning if there is a group by statement.</li>
 * <li><b>:_grpbys</b> - Indicates the set of group bys, this will be a list of
 * lists, one list for each group by key, and each group by column will be in
 * that list.
 * <li><b>:_groupby</b> - A synonym for <b>:_grpby</b>.</li>
 * <li><b>:_groupbys</b> - A synonym for <b>:_grpbys</b>.</li>
 * </ul>
 * <p>
 * Special bind variables are mainly used in function calls however they can
 * also be used just about anywhere.</li>
 * </ul>
 * <h3>Examples</h3>
 * 
 * <pre>
 ...
 * <h3>Accessors</h3>
 * <p>
 * It is also possible for bind variables (including the special variables) to
 * have accessors. For example:
 * 
 * <pre>
 ...
 * </pre>
 * <p>
 * Would cause all the bind variables in the query to be returned. Also, if the
 * ? in the next query is an instance of <code>java.lang.String</code>.
 * 
 * <pre>
 *   SELECT ?.length
 *   FROM   java.lang.Object
...
public class BindVariable extends ValueExpression {
	...
	static {
		...
		BindVariable.SPECIAL_VAR_NAMES
		        .put(Query.GRPBY_OBJ_VAR_NAME_SYNONYM, "");
	...
	public boolean equals(Object o) {
		...
		if ((b.getName() != null) && (this.name != null)
		        && (b.getName().equals(this.name))) {

			if ((this.acc != null) && (b.getAccessor() != null)
	...
	/**
	 * Get the expected return type. The exact class returned here is dependent
	 * (obviously) on what the bind variable represents. Wherever possible it
	 * attempts to get the most specific class for the variable. It is generally
	 * better to set the variables prior to executing the:
	 * {@link Query#parse(String)} method to ensure that the correct class is
	 * returned here.
	 * 
	 * @param q
	 *            The Query object.
	 * @return The return type class or <code>java.lang.Object.class</code> if
	...
	private void initForGroupByName(String n, Query q)
	        throws QueryParseException {
		...
		if (grpBys == null) {
			...
			throw new QueryParseException(
			        "Use of special group by object bind variable: "
			                + name
		...
		if (rest.length() > 0) {
			...
			if (grpbyind > (grpBys.size())) {
				...
				throw new QueryParseException("Special bind variable name: "
				        ...
				        + grpbyind + " however there are only: "
				        + grpBys.size() + " GROUP BYs defined.");
	...
	/**
	 * Initialises this bind variable. If the bind variable is "anonymous" then
	 * a name is gained for it from the Query object. If there is a value then
	 * it is gained from the Query object and cached. Also, if there is an
	 * accessor defined then it is inited where possible.
	 * 
	 * @param q
	 *            The Query object.
	 * @throws QueryParseException
	 *             If the bind variable cannot be inited.
	 */
	public void init(Query q) throws QueryParseException {
		...
		if ((this.val != null) && (this.acc != null)) {
			...
			try {
				...
				throw new QueryParseException(
				        "Unable to get value from accessor: " + this.acc
				                + " and class: "
				                + this.val.getClass().getName()
				                + " from bind variable: " + this.name, e);
		...
		if ((this.acc != null) && (this.get == null)) {
			...
			// It precludes the init occurring if we are working on
			// java.lang.Object
	 ...
	 * 
	 * @param o
	 *            The current object. Note that this variable isn't used in this
	 *            method.
	 * @param q
	 *            The Query object.
	 * @return The value.
	 * @throws QueryExecutionException
	 *             If something goes wrong during the accessing of the value.
	 */
		...
		if (this.get != null) {
			...
			try {
				...
				throw new QueryExecutionException(
				        "Unable to get value for accessor: " + this.acc
				                + ", class: "
	 ...
	 * <code>true</code> value. See:
	 * {@link ArithmeticExpression#isTrue(Object,Query)} for details of how the
	 * return value is determined.
	 * 
	 * @param o
	 *            The current object. Not used in this method.
	 * @param q
	 *            The Query object.
	 * @return <code>true</code> if the bind variable evaluates to
	 *         <code>true</code>.
	 * @throws QueryExecutionException
	 *             If a problem occurs during evaluation.
	 */
	...
	/**
	 * Evaluates the value of this bind variable. This is just a thin-wrapper
	 * around: {@link #getValue(Object,Query)}.
	 * 
	 * @param o
	 *            The current object, not used in this method.
	 * @param q
	...
	/**
	 * Returns a string version of this bind variable. Returns in the form: ? |
	 * ":" [ "_" ] Name
	 * 
