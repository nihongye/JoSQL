 ...
 * <p>
 * Since expression lists are also expressions it is possible to nest them to
 * the nth degree, if desired. i.e.
 * 
 * <pre>
...
public class ExpressionList extends ValueExpression {
	 ...
	 *             If one of the expressions cannot be inited.
	 */
	...
	/**
	 * Gets the value of the expressions, this will return a list of the values
	 * for each of the expressions in the list. In essence
	 * {@link Expression#getValue(Object,Query)} is called on each of the
	 * expressions.
	 * 
	 * @param o
	 *            The current object.
	 * @param q
	 *            The Query object.
	 * @return A list of the values, if there are no expressions in the list
	 *         then an empty list is returned.
	 * @throws QueryExecutionException
	 *             If something goes wrong the acquisition of the values.
	 */
	 ...
	 * {@link Expression#getValue(Object,Query)} on each expression directly and
	 * returns <code>true</code> for the first non-null value found, as such if
	 * any of your expressions triggers side-effects then this method should not
	 * be used.
	 * 
	 * @param o
	 *            The current object.
	...
	/**
	 * Evaluates the value of this expression list. This is just a thin-wrapper
	 ...
	 * @throws QueryExecutionException
	 *             If there is a problem getting the values.
	 */
	...
	/**
	 * Returns a string version of this expression list. Returns in the form:
	...
	/**
	 * Returns <code>true</code> if this expression list is empty (no
	 * expressions) or if ALL of the expressions have a fixed result.
	 * 
	 * @param q
	 *            The Query object.
