...
/**
 * This class allows you to filter the stack trace of a Throwable, so cutting
 * down on the (sometimes) pointless long stack traces.
 * <p>
 * Usage:
 * 
 * <pre>
...
public class StackTraceElementFilter extends AbstractJoSQLFilter {
	 ...
	 */
	public StackTraceElementFilter(Query q) throws IllegalStateException,
	        QueryParseException {
	...
	public boolean accept(StackTraceElement s) throws QueryExecutionException {
		...
		return this.q.getWhereClause().isTrue(s, this.q);

	}

	/**
	 * Filter the specified stack trace and return the new stack trace that can
	 * then be set in the throwable.
	 * 
	 * @param s
	 *            The stack trace.
	 * @return The new stack trace, filtered.
	 * @throws QueryExecutionException
	 *             If the where clause cannot be executed against a particular
	 *             element.
	 */
	...
	/**
	 * Filter the throwable, but will also filter any causes (right up the cause
	 * chain) as well. Equivalent to calling: {@link #filter(Throwable,boolean)}
	 ...
	 */
	public void filter(Throwable t) throws QueryExecutionException {
	...
	/**
	 * Filter the throwable, but will also filter any causes (right up the cause
	 * chain) as well if the <b>filterCause</b> boolean is set to
	 * <code>true</code>.
	 * 
	 * @param t
	 *            The throwable instance to filter.
	 * @param filterCause
	 *            When set to <code>true</code> will also filter the cause chain
	 *            as well.
	 * @throws QueryExecutionException
	 *             If the where clause cannot be executed.
	 */
	public void filter(Throwable t, boolean filterCause)
	        throws QueryExecutionException {
