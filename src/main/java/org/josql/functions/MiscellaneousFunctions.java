...
public class MiscellaneousFunctions extends AbstractFunctionHandler {
	 ...
	 * 
	 * @param zeroTime
	 *            If set to <code>true</code> then the date returned will have
	 *            it's time fields set to zero.
		...
		for (int i = 0; i < s; i++) {
			...
			try {
				...
				throw new QueryExecutionException(
				        "Unable to get value from accessor: " + get
				                + " from object: " + i, e);
	...
	public void cache(List allobjs, Expression exp)
		...
		for (int i = 0; i < s; i++) {
			...
			try {
				...
				this.q.setSaveValue(o, exp.getValue(o, q));
	 ...
	 * 
	 * @param oExp
	 *            The expression to use to evaluate to get the object.
	 * @param accExp
	...
	public Object accessor(Expression oExp, Expression accExp) throws Exception {
		...
		try {
			...
			throw new QueryExecutionException("Unable to evaluate expression: "
			        + accExp + " to get accessor.");

		}

		if (a == null) {

			throw new QueryExecutionException("Accessor expression: " + accExp
			        + " evaluates to null for object: " + o
			        + " returned from expression: " + oExp);
	 ...
	 * 
	 * @param o
	 *            The object to call the accessor on.
	 * @param acc
	 *            The accessor.
	 * @return The value returned from the accessor.
	 * @throws Exception
	...
	public Object accessor(Object o, String acc) throws Exception {
		...
		Getter g = (Getter) this.accessorCache
		        .get(o.getClass().getName() + acc);
	...
	public Object ifThen(Expression ifcond, Expression thenVal)
	        throws QueryExecutionException {
	...
	public Object ifThenElse(Expression ifcond, Expression thenVal,
	        Expression elseVal) throws QueryExecutionException {
	 ...
	 * <b>clazz</b> expression. In effect the following is performed:
	 * 
	 * <pre>
	 ...
	 * 
	 * @param obj
	 *            The expression that represents the object to against.
	 * @param clazz
	 *            The expression that represents the class of the type to
	 *            compare against.
	 * @throws QueryExecutionException
	 *             If either of the expressions can't be evaluated.
	 */
	public Boolean instanceOf(Expression obj, Expression clazz)
	        throws QueryExecutionException {

		return Boolean.valueOf(clazz.getValue(this.q.getCurrentObject(), q)
		        .getClass()
		        .isInstance(obj.getValue(this.q.getCurrentObject(), q)));
