...
public class JoSQLParser implements JoSQLParserConstants {
	 ...
	 * String MultiName(): {
	 * 
	 * StringBuffer v = new StringBuffer (); Token val = null;
	 * 
	 * } {
	 * 
	 * // Is in form... name[name.name] val = Name() [ "[" [ <K_KEY> | <K_VALUE>
	...
	final public SelectItemExpression SelectItem(Query q) throws ParseException {
		...
		case 71:
			...
			csei = new SelectItemExpression();
			csei.setExpression(expression);
			if (jj_2_6(2)) {
				alias = Alias();
				csei.setAlias(alias);
			} else {
	...
	final public NewObjectExpression NewObjectExpression()
	...
	final public OrderBy OrderBy() throws ParseException {
		...
		if (jj_2_10(2)) {
			...
			cInt = Integer.parseInt(ci.image);
			oe.setIndex(cInt);
		} else {
			switch ((jj_ntk == -1) ? jj_ntk() : jj_ntk) {
			case K_AS:
	...
	final public Limit Limit() throws ParseException {
		...
		if ((start != null) && (!(start instanceof ValueExpression))) {

			{
				if (true)
					throw new ParseException(
					        "Only expressions that return a numeric value are supported as the start value for the LIMIT part of the query.");
			}
		...
		if (!(rows instanceof ValueExpression)) {

			{
				if (true)
					throw new ParseException(
					        "Only expressions that return a numeric value are supported as the rows value for the LIMIT part of the query.");
			}
	...
	final public Expression RegularCondition() throws ParseException {
		...
		case 69:
			...
			case 63:
				...
				GTLTExpression lt = (GTLTExpression) result;
				lt.setIgnoreCase(ignoreCase);
				lt.setType(Utilities.GT);
				break;
			case 64:
				jj_consume_token(64);
				result = new GTLTExpression();
				lt = (GTLTExpression) result;
				lt.setIgnoreCase(ignoreCase);
				lt.setType(Utilities.LT);
				break;
			case 65:
				jj_consume_token(65);
				result = new EqualsExpression();
				EqualsExpression ee = (EqualsExpression) result;
				ee.setIgnoreCase(ignoreCase);
				break;
			case 66:
				jj_consume_token(66);
				result = new GTLTExpression();
	...
	final public InExpression InExpression() throws ParseException {
		...
		if (!(left instanceof ValueExpression)) {

			{
				if (true)
					throw new ParseException(
					        "The left-hand side of an [NOT] IN clause must be a value expression.");
			}
...

				{
					if (true)
						throw new ParseException(
						        "Item: "
						                + (i + 1)
						                + " from the [NOT] IN clause is NOT a value expression, is: \""
	...
	final public BetweenExpression BetweenExpression() throws ParseException {
		...
		if (!(left instanceof ValueExpression)) {

			{
				if (true)
					throw new ParseException(
					        "The left-hand side of an [NOT] BETWEEN clause must be a value expression, is: \""
					                + left + "\"");
			}
		...
		if (!(start instanceof ValueExpression)) {

			{
				if (true)
					throw new ParseException(
					        "The START value of an [NOT] BETWEEN clause must be a value expression, is: \""
					                + start + "\"");
			}
		...
		if (!(end instanceof ValueExpression)) {

			{
				if (true)
					throw new ParseException(
					        "The END value of an [NOT] BETWEEN clause must be a value expression, is: \""
					                + end + "\"");
			}
	...
	final public List AliasedSQLExpressionList() throws ParseException {
		...
		String alias = null;
		expr = ExpressionList();
		aexp = new AliasedExpression();
		aexp.setExpression(expr);
		expressions.add(aexp);
		if (jj_2_19(2)) {
			alias = Alias();
			aexp.setAlias(alias);
		} else {
		...
		label_14: while (true) {
			...
			if (!(left instanceof ValueExpression)) {

				{
					if (true)
						throw new ParseException(
						        "The left-hand side of an arithmetic expresion (+, -, *, / or %) must be a value expression.");
				}
			...
			if (!(right instanceof ValueExpression)) {

				{
					if (true)
						throw new ParseException(
						        "The right-hand side of an arithmetic expresion (+, -, *, / or %) must be a value expression.");
				}
	...
	final public Expression PrimaryExpression() throws ParseException {
		...
		if (jj_2_26(2)) {
			...
			case K_NULL:
				jj_consume_token(K_NULL);
				retval = new ConstantExpression();
				ConstantExpression ce = (ConstantExpression) retval;
				ce.setValue(null);
				break;
			default:
				jj_la1[62] = jj_gen;
				if (jj_2_28(2)) {
					...
					BooleanExpression be = (BooleanExpression) retval;
					be.setValue(Boolean.TRUE);
				} else if (jj_2_29(2)) {
					jj_consume_token(K_FALSE);
					retval = new BooleanExpression();
					BooleanExpression be = (BooleanExpression) retval;
					be.setValue(Boolean.FALSE);
				} else {
					switch ((jj_ntk == -1) ? jj_ntk() : jj_ntk) {
					case 48:
					case 49:
					...
					default:
						...
						if (jj_2_30(2147483647)) {
							...
							retval = new ConstantExpression();
							ce = (ConstantExpression) retval;
							ce.setValue(new Double(tmp + token.image));
							...
							accName = Name();
							retval = new Accessor();
							Accessor a = (Accessor) retval;
							a.setAccessor(accName);
						} else if (jj_2_34(2)) {
							switch ((jj_ntk == -1) ? jj_ntk() : jj_ntk) {
							case 70:
							case 71:
							...
							case S_CHAR_LITERAL:
								...
								retval = new ConstantExpression();
								ce = (ConstantExpression) retval;
								ce.setValue(token.image.substring(1,
	...
	final private boolean jj_3R_149() {
		if (jj_scan_token(K_GROUP_BY_RESULTS))
			return true;
		return false;
	}

	final private boolean jj_3R_148() {
		if (jj_scan_token(K_HAVING_RESULTS))
			return true;
		return false;
	}
	...
	final private boolean jj_3R_147() {
		if (jj_scan_token(K_WHERE_RESULTS))
			return true;
		return false;
	}

	final private boolean jj_3_29() {
		if (jj_scan_token(K_FALSE))
			return true;
		return false;
	}

	final private boolean jj_3_28() {
		if (jj_scan_token(K_TRUE))
			return true;
		return false;
	}

	final private boolean jj_3R_146() {
		if (jj_scan_token(K_RESULTS))
			return true;
		return false;
	}
	...
	final private boolean jj_3R_68() {
		if (jj_scan_token(S_CHAR_LITERAL2))
			return true;
		return false;
	}
	...
	private static void jj_la1_0() {
		jj_la1_0 = new int[] { 0x0, 0x0, 0x0, 0x0, 0x0, 0xfff6ffe0, 0xfff6ffe0,
		        0x100000, 0x2000000, 0x800000, 0x400000, 0x80000000,
		        0x80000000, 0x800, 0x0, 0x0, 0xfff6ffe0, 0x0, 0xfff7ffe0,
		        0xfff7ffe0, 0x0, 0x0, 0xfff7ffe0, 0x0, 0x0, 0x0, 0x0,
		        0xfff7ffe0, 0xc000, 0xc000, 0xfff6ffe0, 0x0, 0xfff7ffe0,
		        0xfff7ffe0, 0x0, 0x0, 0x0, 0x0, 0xfff7ffe0, 0x2000, 0x0, 0x0,
		        0x20000, 0x800, 0x2000, 0x2000, 0x0, 0x2000, 0x0, 0x0, 0x0,
		        0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x10000,
		        0x0, 0x0, 0xfff7ffe0, 0x0, 0x0, };
	}

	private static void jj_la1_1() {
		jj_la1_1 = new int[] { 0x70000, 0x80000, 0x80000, 0x200000, 0x80000,
		        0x5f, 0x65f, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0xf, 0x400000,
		        0x400000, 0x65f, 0x400000, 0x5971e5f, 0x5171e5f, 0x400000,
		        0x10000000, 0x5f, 0x170000, 0x400000, 0x400000, 0x400000,
		        0x5171e5f, 0x0, 0x0, 0x105f, 0x400000, 0x5171e5f, 0x4171e5f,
		        0x40000000, 0x0, 0x80000000, 0xc0000000, 0x4171e5f, 0x0,
		        0x40000000, 0x40000000, 0x0, 0x0, 0x0, 0x0, 0x40000000, 0x0,
		        0x400000, 0x400000, 0x0, 0x800000, 0x0, 0x0, 0x0, 0x0, 0x0,
		        0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x170000, 0x600, 0x5171e5f,
		        0x80000, 0x80000, };
	}

	private static void jj_la1_2() {
		jj_la1_2 = new int[] { 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0,
		        0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0xc0, 0xc0, 0x0,
		        0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0xc0, 0x0, 0x0, 0x0, 0x0, 0xc0,
		        0xc0, 0x0, 0x30, 0x3f, 0x3f, 0xc0, 0x0, 0x0, 0x0, 0x0, 0x0,
		        0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0xc0, 0x300, 0xc0, 0xc0, 0xc0,
		        0xc0, 0xc0, 0xc0, 0xc0, 0xc0, 0xc0, 0xc0, 0x0, 0x0, 0x0, 0xc0,
		        0x0, 0x0, };
	}
