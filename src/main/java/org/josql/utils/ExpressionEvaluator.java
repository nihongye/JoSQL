 ...
 * Usage:
 * <p>
 * Use the static methods to evaluate the expression in one call, for instance
 * to find out details about a file:
 * <p>
 * String exp = "path + ', size: ' + formatNumber(length) + ', last modified: '
 * + formatDate(lastModified)<br />
 * String details = ExpressionEvaluator.getValue (exp, new File
 * ('/home/me/myfile.txt'));
 */
public class ExpressionEvaluator {
	 ...
	 *             If the expression cannot be parsed.
	 */
	public ExpressionEvaluator(String exp, Class cl, List fhs)
	        throws QueryParseException {
	...
	/**
	 * Get the query associated with the expression, use this to setup bind
	 * variables, function handlers and so on, which of course must be setup
	...
	/**
	 * Evaluate the expression against the list of objects passed in and return
	 * the value.
	 * 
	 * @param l
	 *            The list of objects to evaluate the expression against.
	 * @return The values gained when evaluating the expression against all the
	 *         objects in the list.
	 * @throws QueryExecutionException
	 *             If the expression cannot be executed.
	 */
	 ...
	 * @param o
	 *            The object to evaluate the expression against.
	 * @return The value gained when evaluating the expression against the
	 *         object.
	 * @throws QueryExecutionException
	 *             If the expression cannot be executed.
	 */
	 ...
	 * 
	 * @param exp
	 *            A string representation of the expression to evaluate.
	 * @param o
	 *            The object to evaluate the expression against.
	 * @return The value of calling Expression.isTrue (Query, Object).
	 * @throws QueryParseException
	 ...
	 *             If the expression cannot be executed.
	 */
	public static boolean isTrue(String exp, Object o)
	 ...
	 *             If the expression cannot be executed.
	 */
	public static List getValues(String exp, List l)
	        throws QueryParseException, QueryExecutionException {
	 ...
	 *             If the expression cannot be executed.
	 */
	public static Object getValue(String exp, Object o)
	        throws QueryParseException, QueryExecutionException {
